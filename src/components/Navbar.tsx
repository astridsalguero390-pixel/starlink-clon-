    ...
    <nav className="fixed top-0 left-0 right-0 z-50">
        ...
        <div className="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a href="#residencial" className="text-foreground text-xs tracking-[0.2em] font-medium hover:text-muted-foreground transition-colors">
                RESIDENCIAL
              </a>
              <a href="#portatil" className="text-foreground text-xs tracking-[0.2em] font-medium hover:text-muted-foreground transition-colors">
                PORTÁTIL
              </a>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button
              ...
              className={`text-xs tracking-[0.15em] font-medium px-3 py-1.5 transition-colors ${
                activeTab === "empresas" ? "text-foreground underline underline-offset-4" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              EMPRESAS
            </button>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-background border-t border-border px-6 py-6 flex flex-col gap-4">
          <a href="#residencial" className="text-foreground text-sm tracking-[0.2em] font-medium" onClick={() => setMobileOpen(false)}>RESIDENCIAL</a>
          <a href="#portatil" className="text-foreground text-sm tracking-[0.2em] font-medium" onClick={() => setMobileOpen(false)}>PORTÁTIL</a>
          <div className="border-t border-border pt-4 mt-2 flex gap-4">
            ...
            <button className="text-muted-foreground text-sm tracking-wider font-medium">EMPRESAS</button>
          </div>
        </div>
      )}
    </nav>
